            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->roles == 'ADMIN')
                        ...
                        <x-jet-nav-link href="{{ route('dashboard.transaction.index') }}" :active="request()->routeIs('dashboard.category.index')">
                            {{ __('Transaction') }}
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('dashboard.user.index') }}" :active="request()->routeIs('dashboard.category.index')">
                            {{ __('User') }}
                        </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->roles == 'ADMIN')
                ...
                <x-jet-responsive-nav-link href="{{ route('dashboard.transaction.index') }}" :active="request()->routeIs('dashboard.category.index')">
                    {{ __('Transaction') }}
                </x-jet-responsive-nav-link>

                <x-jet-responsive-nav-link href="{{ route('dashboard.user.index') }}" :active="request()->routeIs('dashboard.category.index')">
                    {{ __('User') }}
                </x-jet-responsive-nav-link>
            @endif
